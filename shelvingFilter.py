...
Name:           Carlos Meza
Description:
 Use the shelving filter on the wav file, then use fft on the original wav and then after the shelving filter. Then plot
 both signals and output the clean file using only real values.
"""
